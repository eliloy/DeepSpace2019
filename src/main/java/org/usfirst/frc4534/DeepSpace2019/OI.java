...
public class OI {
    ...
    public OI() {
        ...
        // SmartDashboard.putData("DriveStraightDistance", new DriveStraightDistance(2, 0.5));
        ...
        SmartDashboard.putData("ExtendKablam", new ExtendKablams());
        // SmartDashboard.putData("ExtendKabloom", new ExtendKabloom());
        // SmartDashboard.putData("TurnAngle", new TurnAngle(90, 0.5));
